    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12">
      ...
      <div className="lg:w-1/2">
        <h2 className="text-4xl font-extrabold text-blue-600 mb-6">
          Un entorno diseñado para la <span className="text-orange-500">felicidad</span>
        </h2>

        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
          Nuestras instalaciones cumplen con todas las normativas europeas de seguridad. 
          Los peques podrán explorar de forma segura mientras los padres y madres descansan en la zona común.
        </p>
