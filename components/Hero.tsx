  ...
  return (
    <div className="relative h-screen flex items-center justify-center overflow-hidden bg-black font-['Baloo_2']">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-[10%] left-[5%] text-[180px] animate-float opacity-90 drop-shadow-[0_0_30px_rgba(255,87,34,0.4)]">🎈</div>
        
        {/* Globo Cian Derecha - Gigante */}
        <div className="absolute top-[15%] right-[5%] text-[160px] animate-float-delayed opacity-90 drop-shadow-[0_0_30px_rgba(0,188,212,0.4)]">🎈</div>
        
        {/* Globo Amarillo Abajo - Gigante */}
        <div className="absolute bottom-[10%] left-[10%] text-[140px] animate-float-slow opacity-80 drop-shadow-[0_0_30px_rgba(255,235,59,0.4)]">🎈</div>
        
        {/* Globo Rosa Abajo Derecha */}
        <div className="absolute bottom-[20%] right-[12%] text-[120px] animate-float opacity-85 drop-shadow-[0_0_30px_rgba(233,30,99,0.4)]">🎈</div>
        
        {/* Confeti y Formas */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 flex gap-12 opacity-80">
          <span className="text-orange-500 text-6xl animate-spin" style={{ animationDuration: '5s' }}>✨</span>
          <span className="text-yellow-400 text-5xl rotate-12">⭐</span>
          <span className="text-pink-500 text-6xl -rotate-12 animate-pulse">〰️</span>
        </div>
        ...
        {[...Array(25)].map((_, i) => (
          <div
            ...
            style={{
              ...
              backgroundColor: ['#ff5722', '#00bcd4', '#4caf50', '#e91e63', '#facc15'][Math.floor(Math.random() * 5)],
      ...
      <div className="relative z-10 text-center px-4 max-w-7xl">
        ...
        <div className="mb-6 flex flex-col items-center animate-[zoomIn_1s_ease-out]">
          <div className="text-8xl md:text-[160px] font-black leading-none tracking-tight flex flex-wrap justify-center items-end drop-shadow-[0_0_40px_rgba(255,255,255,0.15)]">
            <span className="text-[#ff5722]">J</span>
            <span className="text-[#00bcd4]">u</span>
            <span className="text-[#4caf50]">g</span>
            <span className="text-[#e91e63]">a</span>
            <span className="text-white mx-2 md:mx-4 text-6xl md:text-[110px] self-center">i</span>
            <span className="text-[#9c27b0]">C</span>
            <span className="text-[#ff5722]">e</span>
            <span className="text-[#00bcd4]">l</span>
            <span className="text-[#e91e63]">e</span>
